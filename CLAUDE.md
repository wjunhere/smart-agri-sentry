...
* 可以通过ssh连接到RDKX5板端 ，板端环境是Ubuntu22.04，ssh rdk ，密码是sunrise，pc端设置为无密登录，项目放在了\~\dev\_ws,项目从本项目克隆而来，只是文件夹名重命名为dev\_ws， 通过git进行版本管理，如果使用typec连接板端，则是ssh sunrise@192.168.128.10
...
* yolo模型训练在"D:\wjun\data\yolo"，番茄病害识别模型在"D:\wjun\data\toamtos"，小麦病害识别模型在"D:\wjun\data\wheat"，草莓病害识别模型在"D:\wjun\data\strawberry"
